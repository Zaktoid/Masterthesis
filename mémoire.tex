...
\begin{preuve}
    ...
    \end{equation*}
    De façon similaire à \ref{fold}, on applique le théorème des fonctions implicites, donc quit à reduire l'intervalle $]-\delta,+\delta[$, on peut supposer l'existance d'une fonction 
        \begin{equation*}
