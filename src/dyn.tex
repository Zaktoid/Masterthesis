...
\begin{preuve}
    ...
    \end{equation}
    L'équation \eqref{eq-dyn-3}, quand $\partial_s\mu(0)=0$, peut être résolue pour $\partial_sw(0)\in (I-\pi_1)X$.
    Ce qui nous donne
    \begin{equation*}\label{deriv-w}
        \partial_s w(0)=-(I-\pi_1)(D_1F(0,\lambda_0))^{-1}(I-\pi_2)D^2_{11}F(0,\lambda_0)[\hat{v_0},\hat{v_0}]=\partial^2_sx(0)
    \end{equation*}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \\&- 3\hat{v_0}^*\left(D^2_{11}DF(0,\lambda_0)[\hat{v_0},-(I-\pi_1)(D_1F(0,\lambda_0))^{-1}(I-\pi_2)D^2_{11}F(0,\lambda_0)[\hat{v_0},\hat{v_0}]]\right)\\
...
\begin{definition}
    ...
    soient \\
    $\gamma_1(s)=\left(x_1(s),\lambda_1(s)\right)$,$\gamma_2(s)=\left(x_2(s),\lambda_2(s)\right)$ deux courbes de solutions passant par $(x_0,\lambda_0)$. Supposons $\pi_1x_i(s)=v_0+y_i(s)\hat{v}_0$, $i=1,2$. Si il existe des paramètres $s_1,s_2$ tels que $y_1(s_1),y_2(s_2)$ sont des zéros consécutifs de $\Psi(\cdot,\lambda)$ en $\lambda=\lambda(s_1)=\lambda(s_2)$ alors les courbes sont dites adjacentes
\end{definition}
