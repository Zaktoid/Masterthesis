...
\begin{preuve}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            &+D^2_{11}F(0,\lambda)[\partial^2_s x(0)]+D^2_{12}F(0,\lambda_0)\hat{v_0}\partial^2_s\lambda(0)\\
...
\end{definition}
    ...
    \begin{proposition}
        Supposons que
        \begin{itemize}
            \item $\kappa_0\in\R$ soit tel que $i\kappa_0$ est une valeur propre simple  de $D_1F(0,\lambda_0)$ avec un vecteur propre $\phi_0\notin R(i\kappa_0I -D_1F(0,\lambda_0)) $
            ...
            \item Si $n\in\mathbb{Z}\setminus\left\{1,-1\right\}$ alors $n\kappa_0$ n'est pas valeur propre de $D_1F(0,\lambda_0)$
        \end{itemize}
        Alors l'opérateur linéaire
        \begin{equation*}
            J_0=D_1 G(0,\kappa_0,\lambda_0)=\kappa_0\partial_t -D_1F(0,\lambda_0)
        \end{equation*}
        est de Fredholm, d'indice nul et tel que $\dim\ker J_0=2$
    \end{proposition}
    Nous pouvons désormais appliquer la réduction de Lyapunov-Schmidt à $G$
    \newpage
\end{document}