...
\begin{cases} 
    ...
    (\operatorname*{Id} - \pi_2) F(\pi(x) +(\operatorname*{Id}-\pi_1)(x),\lambda) = 0 
\end{cases}
    \end{equation}
...
\end{preuve}
On résume la procédure ci-dessus: On scinde l'espace d'arrivée en 2 grâce à $\pi_2$, ensuite on obtient une description (sur un certain sous voisinage) des solutions de la partie $\ker D$, et on applique la seconde projection pour avoir une solution du système \ref{SysteLP}.
...
\begin{theobox} {Fold}{}\label{fold}
    ...
    \begin{itemize}
        ...
        \item $F(x_0,\lambda_0)=0$ et $\dim (\ker D_1F(x_0,\lambda_0))=\dim (Y/ \ker D_1F(x_0,\lambda_0))=1$
...
\begin{theobox}{Crandall-Rabinowitz, bifurcation simple}{} 
    ...
    \begin{itemize}
        ...
        \item $F(0,\lambda_0)=0$ et $\dim (\ker D_1(0,\lambda_0))=\dim (Y/ \ker D_1(0,\lambda_0))=1$
