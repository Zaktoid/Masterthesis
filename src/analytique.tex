...
Soient $U\times V\subseteq X\times \Lambda $ un ouvert, $(x_0,\lambda_0)\in  U\times V$, et soit $F\in C^1(U\times V,Y)$ telle que $F(x_0,
\lambda_0)=0$ et $F(\cdot,\lambda_0)$ est de Fredholm. Soit de plus $Y_0$ le supplémentaire fermé de $\im D_1F(x_0,\lambda_0)$. Alors il existe $U_1\times V_1$ un voisinage ouvert de $(x_0,\lambda_0)$ dans $U\times V$,  $U'_1$  un ouvert de $\ker D_1 F(x_0,\lambda_0)$ et $\Phi\in C^0(U'_1\times V_1,Y_0)$
\begin{equation*}
...
\end{cases}
    \end{equation}
Considérons alors des ouverts $U'$,$W$,$V_0$  de $\ker D$ ,$X_0$ et $V$ respectivement tels que 
...
Ainsi, en posant $U_1=U'_1+W_1$, les ouverts $U_1$ et $V_1$, la fonction
...
\begin{theobox}{}{}\label{fold}
    ...
    \begin{itemize}
        ...
        \item $F(x_0,\lambda_0)=0$ et $D_1F(x_0,\lambda_0)$ de Fredholm d'indice nul et $\dim (\ker D_1F(x_0,\lambda_0))=1$
...
\end{remarque}
La plupart des articles de théorie des bifurcations supposent l'existence d'une branche triviale de solutions i.e $F(0,\lambda)=0$ au voisinage de $\lambda_0$. Ainsi, on parlera de (vraie) bifurcation en $(x_0,\lambda_0)$ lorsque tout voisinage $V$ de $(0,\lambda_0)$ contient des solutions non triviales.
...
\begin{theobox}{Crandall-Rabinowitz, bifurcation simple}{} 
    ...
    \begin{itemize}
        ...
        \item $F(0,\lambda_0)=0$, $D_1F(0,\lambda_0)$ de Fredholm et $\dim (\ker D_1F(0,\lambda_0))=\dim (Y/ \im D_1F(0,\lambda_0))=1$
...
\end{theobox}
\begin{preuve}
    Bien sûr, on applique immédiatement \ref{LP-redux}. Avec les notations de ce théorème, considérons alors $\Phi: U_1'\times V_1\rightarrow Y_0$ la fonction de bifurcation, par hypothèse
    \begin{equation*}
...
\begin{definition}
    Avec les notations habituelles, un zéro $(x_0,\lambda_0)$ de $F(x,\lambda)$ est un \coldef{élément de bifurcation}  s'il existe deux suites $(x_i,\lambda_i)_{i\in\mathbb{N}},(x'_i,\lambda_i)_{i\in\mathbb{N}}$ qui convergent vers $(x_0,\lambda_0)$ telles que $x'_i\neq x_i$ pour tous $i\in\mathbb{N}$ et 
...
\end{remarque}
Dans la suite de cette section, nous supposons $F\in C^k (U\times V,Y)$ ($k\geq 1$) sur un ouvert contenant $(x_0,\lambda_0)$ et  $\operatorname{Ind}(D_1F(x_0,\lambda_0))=0$ (cf. remarque \ref{remarque INd=0}). Posons également $D_1=D_1F(x_0,\lambda_0)$ et $D_2=D_2F(x_0,\lambda_0)$
