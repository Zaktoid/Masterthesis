...
\begin{preuve}
    Par le lemme précédent,  $X_0$ est bien bien une variété de même dimension que $Y_0$. $Y_0$ est un espace vectoriel, il est orientable, il suffit alors d'orienter $X_0$ de tels sorte que $X_0$ et $Y_0$ sont orientés selon $F$. L'égalité des degrés est alors une conséquence de la définition du degré de Brouwer
\end{preuve}
