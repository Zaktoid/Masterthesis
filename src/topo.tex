...
\begin{preuve}
    Par le lemme précédent,  $X_0$ est bien bien une variété de même dimension que $Y_0$, on montre alors qu'elle est orientable.
\end{preuve}
...
\begin{definition}
    ...
    \end{equation*}
    avec $y_0$ une valeur régulière suffisement proche de $y$
\end{definition}
...
\begin{preuve}
    ...
    \begin{equation*}
        \operatorname{sign}D_2F(0,\lambda_1)\operatorname{sign}D_2F(0,\lambda_1)<0.
    \end{equation*}
