...
\begin{preuve}
    ...
    $F(x_0)$ dans $Y$, considérons, avec les notations habituelles, $\pi: Y\rightarrow Y_0$ la projection canonique
    et 
    \begin{equation*}
        \varphi : u_0\times \ker DF(x_0)\rightarrow  Y_0
    \end{equation*}
    on applique alors le théorème de Morse-Sard en dimension finie, on récupère une valeur régulière $z$ de $\varphi$ dans $\pi (U_1)$. Soit $y\in\pi^{-1}(z)\cap U_1$, $y$ est alors une valeur régulière de $F$.
...
\begin{definition}
    ...
    $P(x,D)=\sum_{|\alpha|\leq m} c_{\alpha}(x) D^{\alpha}$ est un polynôme de degré $m$ en $D_1,\cdots,D_n$ et $l\geq m\geq 1$, alors un opérateur de la forme 
...
\begin{definition}
    ...
    {elliptique } en $x_0$ si $m=2p$ et si le polynôme $P(x,\xi)_m$ est 
