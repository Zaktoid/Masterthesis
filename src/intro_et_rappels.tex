...
\todomaybe{clean up un peu Sard-Smale si j'ai le time}
...
temps"(de façon générique voir [SROUCE (mémoire de Thelma ?)]), il s'agit d'une variété. Notez cependant qu'un ensemble maigre peut avoir des points d'accumulation ($\mathbb{Q}$, par exemple).
\begin{exemple}
