...
On peut montrer que c'est un élément de $\mathcal{L}(X,Y)$,nous renvoyons le lecteur vers la section 8.6 de \cite{zeidler1986nonlinear}
...
\begin{equation}\label{SCHMIDTopreminder}
    U=-D_1+ \sum_{i=1}^n x_i^{*} D_2 \lambda_i
\end{equation}
