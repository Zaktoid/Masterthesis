...
\end{preuve}
On peut interpréter ce résultat de la façon suivante: lorsque l'opérateur dérivée est de Fredholm et que l'espace de paramètres est de dimension finie, le lieu d'annulation de $F$ est en bijection avec le lieu d'annulation d'une fonction définie entre deux espaces de dimension finie. la fonction $\Phi$ du résultat précédent est appelée la fonction de \textit{bifurcation}.
