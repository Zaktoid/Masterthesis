...
En applique le théorème des fonctions implicites, on en tire  immédiatement le résultat suivant :
\begin{proposition}
    Si $(x_0,\lambda_0)$ est un zéro de type $(0,n)$ alors il existe $V_1\ni \lambda_0$ un ouvert de $\Lambda$ et $U_1$ un ouvert de $X\times \Lambda\in (x_0,\lambda_0)$
    \begin{align*}
        \varphi_1 : V\rightarrow \Lambda \text{ et } \varphi_2 : V\rightarrow  X 
    \end{align*}
    telles que
    \begin{itemize}
        \item $\varphi_1,\varphi_2\in C^(V)k$
        \item $\varphi_1(0)=\lambda_0$ et $\varphi_2(0)=x_0$
        \item $F(\varphi_2(v),\varphi_1(v))$
    \end{itemize}
\end{proposition}
